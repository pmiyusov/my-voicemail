...
//		prefix += "-" + audiosource ;
    ...
    public void onStart(Intent intent, int startId) {
        ...
        int maxDurationMs = 1000 * Integer
                .parseInt(sharedPrefs.getString("max_duration_sec", Integer.toString(com.pmiyusov.mvm.conf.BuildProp.MAX_DURATION_SEC)));
        if (com.pmiyusov.mvm.conf.BuildProp.EVALUATION) {
            maxDurationMs = 1000 * com.pmiyusov.mvm.conf.BuildProp.MAX_DURATION_SEC;
        }
