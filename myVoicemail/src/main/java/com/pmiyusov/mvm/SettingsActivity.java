...
public class SettingsActivity extends PreferenceActivity implements UiCallBackListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(getTitle() + " " + com.pmiyusov.mvm.conf.BuildProp.VERSION_NAME);
        if (com.pmiyusov.mvm.conf.BuildProp.EVALUATION) {
        ...
        //	    			Environment.getExternalStorageDirectory().getAbsolutePath() + "/" + com.pmiyusov.mvm.conf.BuildProp.STORAGE_DIRECTORY_NAME;
        //	    } else {
        //	    	storageDirectoryPath = "/data/local/tmp" + "/" + com.pmiyusov.mvm.conf.BuildProp.STORAGE_DIRECTORY_NAME;   // TOFIX HARDCODED
        //	    }
        //
...
//	}
    ...
    private void setupSimplePreferencesScreen() {
        ...
        if (com.pmiyusov.mvm.conf.BuildProp.EVALUATION) {
            ...
            mds.setSummary(getString(R.string.limited_to) + " " + com.pmiyusov.mvm.conf.BuildProp.MAX_DURATION_SEC + getString(R.string.seconds));
        ...
        public boolean onPreferenceChange(Preference preference, Object value) {
            ...
            if (preference instanceof ListPreference) {
                ...
                if (preference.getKey().equals("greeting_type")) {
                    if (stringValue.equals(com.pmiyusov.mvm.conf.BuildProp.GREETING_TYPE_CUSTOM)) {  // GREETING_TYPE_CUSTOM
                        selectFile();
    ...
    public class VoicemailPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(com.pmiyusov.mvm.conf.BuildProp.PREFS_RESOURCE_ID);
            bindPreferenceSummaryToValue(findPreference("enable_voicemail"));
        }
    }
...
//	
    public void iapOnCreate() {
        ...
        mIaUpgradeHelper.enableDebugLogging(com.pmiyusov.mvm.conf.BuildProp.DEBUG);
    }
    ...
    public void updateUi() {
        ...
        if (mIaUpgradeHelper.isPremium() == false) {
            ...
            String maxDurationString =
                    sp.getString("max_duration_sec", String.valueOf(com.pmiyusov.mvm.conf.BuildProp.MAX_DURATION_SEC));
            //sp.edit().
